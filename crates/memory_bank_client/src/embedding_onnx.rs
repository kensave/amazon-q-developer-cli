...
mod tests {
    ...
    fn create_test_embedder() -> Result<OnnxTextEmbedder> {
    ...
    fn test_embed_single() {
        ...
        let embedder = OnnxTextEmbedder::new().unwrap();
    ...
    fn test_error_handling() {
        ...
        let result = OnnxTextEmbedder::with_model_paths(invalid_path, invalid_path);
    ...
    fn test_ensure_model_files() {
        ...
        let result = OnnxTextEmbedder::ensure_model_files(&model_path, &tokenizer_path);
        assert!(result.is_ok());
    }
}
